...
<body>
	...
	<br>
		<div class = "zoom1";>
			<img src="free_admin_photo.jpg"  style="width:350px";>
		</div>
	
	<br>
	
<div class="card-body">
	<form class="center" method="post" action="../connections/adminconnect.php" >
		<label>Email :</label><br>
			<input type="text" name="Email" placeholder="enter email" style="width:150px;" required><br>
		<br>
