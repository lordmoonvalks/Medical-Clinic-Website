...
if(isset($_POST['update']) && isset($_POST['doctorid']))
{
    header('location: doctorupdate.php?id='.$_POST['doctorid']);

    echo '<div class="center">';

}
else if(isset($_POST['delete']) && isset($_POST['doctorid']))
{
    echo '<div class="center">';
    $query = "DELETE FROM doctors WHERE Id=?";
    $sql = $conn->prepare($query);
    $sql->bind_param('s', $_POST['doctorid']);
    $sql->execute();
...
<center>
<br><br>
<h1 style="color:white">Registered Doctors</h1>
<br><br>
    <form class="center" method="POST" action="adddoctors.php">
    <button type="submit" name="notes-apply">Create New Doctor Account</button>
    </form>
	<div class="center">
